...
return [
    'verify_receipt' => [
        'endpoint' => [
            'develop' => 'https://sandbox.itunes.apple.com/verifyReceipt',
            'production' => 'https://sandbox.itunes.apple.com/verifyReceipt'
        ],
        'secret' => [
            'storyapp' => env('STORYAPP_APPLE_VERIFY_RECEIPT_SECRET')
        ],
        'status' => [
            ...
            21011 => 'The apple in-app purchase guzzle client error, please check log.'
        ]
    ]
];
